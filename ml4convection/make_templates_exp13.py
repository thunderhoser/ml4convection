"""Makes Chiu-net templates for Experiment 13."""
...
OUTPUT_DIR_NAME = '{0:s}/ml4convection_models/experiment13/templates'.format(
    HOME_DIR_NAME
)
TOP_TARGET_DIR_NAME = (
...
LAG_TIME_COUNTS = numpy.array([2], dtype=int)
...
def _run():
    ...
    for i in range(num_l2_weights):
        for j in range(num_lag_time_counts):
            ...
            this_model_file_name = '{0:s}/model_l2-weight={1:.10f}.h5'.format(
                OUTPUT_DIR_NAME, L2_WEIGHTS[i]
            )
