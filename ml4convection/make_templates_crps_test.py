"""Makes U-net templates for CRPS test."""
...
OUTPUT_DIR_NAME = '{0:s}/ml4convection_models/crps_test/templates'.format(
    HOME_DIR_NAME
)
...
LOSS_FUNCTION_NAMES = [
    'crps_neigh2', 'crps_neigh3', 'crps_neigh4', 'crpsfss_neigh4'
]
...
def _run():
    ...
    for i in range(num_loss_functions):
        ...
        neural_net._write_metafile(
            ...
            loss_function_name=LOSS_FUNCTION_NAMES[i], metric_names=[],
            mask_matrix=partial_mask_matrix,
