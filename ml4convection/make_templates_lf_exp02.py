"""Makes U-net templates for Loss-function Experiment 2."""
...
OUTPUT_DIR_NAME = '{0:s}/ml4convection_models/lf_experiment02/templates'.format(
    HOME_DIR_NAME
)
...
def _run():
    ...
    for i in range(num_loss_functions):
        ...
        this_option_dict[u_net_architecture.SMOOTHING_RADIUS_KEY] = (
            None if '_neigh' in LOSS_FUNCTION_NAMES[i] else 2.
        )
