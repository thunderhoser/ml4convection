"""Makes U-net templates for Experiment 7."""
...
OUTPUT_DIR_NAME = '{0:s}/ml4convection_models/experiment07/templates'.format(
    HOME_DIR_NAME
)
MASK_FILE_NAME = (
    '{0:s}/ml4convection_project/radar_data/radar_mask_100km.nc'
