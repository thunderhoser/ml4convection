...
def plot_single_pass_test(
    ...
    # Check input args.
    predictor_names = permutation_dict[gg_permutation.STEP1_PREDICTORS_KEY]
    ...
    backwards_flag = permutation_dict[gg_permutation.BACKWARDS_FLAG]
    perturbed_cost_matrix = permutation_dict[
        gg_permutation.STEP1_COST_MATRIX_KEY]
    ...
    original_cost_array = permutation_dict[
        gg_permutation.ORIGINAL_COST_ARRAY_KEY
    ]
    ...
    if backwards_flag:
        clean_cost_array = permutation_dict[
            gg_permutation.BEST_COST_MATRIX_KEY][-1, :]
    else:
...
def plot_multipass_test(
    ...
    # Check input args.
    predictor_names = permutation_dict[gg_permutation.BEST_PREDICTORS_KEY]
    if num_predictors_to_plot is None:
        num_predictors_to_plot = len(predictor_names)
    ...
    backwards_flag = permutation_dict[gg_permutation.BACKWARDS_FLAG]
    perturbed_cost_matrix = permutation_dict[
        gg_permutation.BEST_COST_MATRIX_KEY]
