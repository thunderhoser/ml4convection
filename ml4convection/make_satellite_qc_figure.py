...
import satellite_io
import border_io
import make_data_overview_figure as make_overview_fig
...
def _run(top_raw_directory_name, top_qc_directory_name, valid_time_string,
    ...
    this_file_name = make_overview_fig._plot_one_satellite_image(
        ...
        title_string='Band-8 brightness temp (Kelvins) before QC'
    )
    ...
    this_file_name = make_overview_fig._plot_one_satellite_image(
        ...
        title_string='Band-8 brightness temp (Kelvins) after QC'
    )
