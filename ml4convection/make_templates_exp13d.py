"""Makes U-net templates for Experiment 13d."""
...
OUTPUT_DIR_NAME = '{0:s}/ml4convection_models/experiment13d/templates'.format(
    HOME_DIR_NAME
)
...
LAG_TIME_COUNTS = numpy.linspace(1, 10, num=10, dtype=int)
