"""Makes U-net templates for Loss-function Experiment 6."""
...
OUTPUT_DIR_NAME = '{0:s}/ml4convection_models/lf_experiment06/templates'.format(
    HOME_DIR_NAME
)
...
LOSS_FUNCTION_NAMES = [
    ...
    'heidke_neigh0', 'heidke_neigh1', 'heidke_neigh2', 'heidke_neigh3',
    'heidke_neigh4', 'heidke_neigh6', 'heidke_neigh8', 'heidke_neigh12',
    'gerrity_neigh0', 'gerrity_neigh1', 'gerrity_neigh2', 'gerrity_neigh3',
    'gerrity_neigh4', 'gerrity_neigh6', 'gerrity_neigh8', 'gerrity_neigh12',
    'peirce_neigh0', 'peirce_neigh1', 'peirce_neigh2', 'peirce_neigh3',
    'peirce_neigh4', 'peirce_neigh6', 'peirce_neigh8', 'peirce_neigh12'
]
