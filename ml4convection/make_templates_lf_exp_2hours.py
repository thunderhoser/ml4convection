"""Makes U-net templates for Loss-function Experiment with 2-hour lead."""
...
OUTPUT_DIR_NAME = (
    '{0:s}/ml4convection_models/lf_experiment_2hours/templates'
...
METRIC_NAMES = []
LOSS_FUNCTION_NAMES = [
    'brier_neigh0', 'fss_neigh0', 'xentropy_neigh0',
    'brier_neigh1', 'fss_neigh1', 'xentropy_neigh1',
    'brier_neigh2', 'fss_neigh2', 'xentropy_neigh2',
    'brier_neigh3', 'fss_neigh3', 'xentropy_neigh3',
    'brier_neigh4', 'fss_neigh4', 'xentropy_neigh4',
    'brier_neigh6', 'fss_neigh6', 'xentropy_neigh6',
    'brier_neigh8', 'fss_neigh8', 'xentropy_neigh8',
    'brier_neigh12', 'fss_neigh12', 'xentropy_neigh12'
]

DEFAULT_OPTION_DICT = {
    u_net_architecture.INPUT_DIMENSIONS_KEY:
        numpy.array([205, 205, 14], dtype=int),
