"""Makes U-net templates for Experiment 2 with quantile-based FSS."""
...
OUTPUT_DIR_NAME = (
    '{0:s}/ml4convection_models/qfss_experiment02/templates'
...
def _run():
    ...
    for j in range(len(QUANTILE_LEVEL_SETS)):
        ...
        this_model_file_name = (
            '{0:s}/num-quantile-levels={1:03d}/model.h5'
        ).format(
            OUTPUT_DIR_NAME, len(QUANTILE_LEVEL_SETS[j])
        )
        ...
        neural_net._write_metafile(
            ...
            loss_function_name='fss_neigh0', metric_names=None,
            quantile_levels=QUANTILE_LEVEL_SETS[j], qfss_half_window_size_px=0,
            mask_matrix=partial_mask_matrix,
