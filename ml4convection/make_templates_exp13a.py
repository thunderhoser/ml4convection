"""Makes U-net templates for Experiment 13a."""
...
OUTPUT_DIR_NAME = '{0:s}/ml4convection_models/experiment13a/templates'.format(
    HOME_DIR_NAME
)
...
LAG_TIME_COUNTS = numpy.linspace(1, 7, num=7, dtype=int)
