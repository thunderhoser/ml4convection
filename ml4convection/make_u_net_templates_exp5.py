...
OUTPUT_DIR_NAME = '{0:s}/ml4convection_models/experiment05/templates'.format(
    HOME_DIR_NAME
)
...
LAG_TIME_COUNTS = numpy.array([1, 2, 3, 4, 5, 7], dtype=int)
        ...
        for j in range(num_dropout_rates):
            ...
            for k in range(num_l2_weights):
                ...
                this_model_file_name = (
                    ...
                    'conv-dropout={2:.3f}_l2-weight={3:.10f}.h5'
                ).format(
