"""Makes architecture for best 60-minute U-net in journal paper."""
...
# Best L_2 weight and number of lag times.  The exact lag times are {0, 20, 40}
# minutes, but these are not specified in the architecture; they are specified
# only at training time, when feeding the input data to the model.
L2_WEIGHT = 10 ** -5.5
NUM_LAG_TIMES = 3
