"""Makes U-net templates with cross-entropy loss for Experiment 13c."""
...
OUTPUT_DIR_NAME = (
    '{0:s}/ml4convection_models/experiment13c/vanilla_xentropy/templates'
...
LOSS_FUNCTION_NAME = 'xentropy_neigh0'
METRIC_NAMES = [
...
def _run():
    ...
    loss_function = custom_losses.cross_entropy(mask_matrix=partial_mask_matrix)
