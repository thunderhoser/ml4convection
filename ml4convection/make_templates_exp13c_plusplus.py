"""Makes U-net++ templates for Experiment 13c."""
...
OUTPUT_DIR_NAME = (
    '{0:s}/ml4convection_models/experiment13c/plusplus/templates'
...
DEFAULT_OPTION_DICT = {
    u_net_pp_architecture.NUM_LEVELS_KEY: 5,
    u_net_pp_architecture.CONV_LAYER_COUNTS_KEY: numpy.full(6, 2, dtype=int),
    u_net_pp_architecture.CONV_LAYER_CHANNEL_COUNTS_KEY:
        numpy.array([16, 24, 32, 48, 64, 96], dtype=int),
    u_net_pp_architecture.ENCODER_DROPOUT_RATES_KEY: numpy.full(6, 0.),
    u_net_pp_architecture.UPCONV_DROPOUT_RATES_KEY: numpy.full(5, 0.),
    u_net_pp_architecture.SKIP_DROPOUT_RATES_KEY: numpy.full(5, 0.),
...
def _run():
    ...
    for i in range(num_l2_weights):
        for j in range(num_lag_time_counts):
            ...
            this_option_dict[u_net_pp_architecture.INPUT_DIMENSIONS_KEY] = (
